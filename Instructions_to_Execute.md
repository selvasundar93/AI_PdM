...
Input|Detail
-----|------
rms|__Root Mean Square__ Value of 1 sec Bearing Vibration Signal
mean|__Mean__ Value of 1 sec Bearing Vibration Signal
...
* Refer Tests folder for feature engineered dataset & examples